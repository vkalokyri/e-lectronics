...
<title>Επιβεβαίωση αλλαγών παραγγελιών</title>
...
<div id="wrap">
   <%@include file="header.html" %>
	...
	<div id="main_menu">
		...
		<table class="bigger" cellspacing="3" cellpadding="3">
                    <tr><td align="center" colspan=2"><h2 style="margin-left:auto">Όλες οι αλλαγές των παραγγελιών πραγματοποιήθηκαν με επιτυχία!</h2></td>
                    <tr><td>
                     <p>&nbsp;</p>
