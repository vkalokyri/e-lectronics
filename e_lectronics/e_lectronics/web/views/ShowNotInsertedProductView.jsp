<%--
    Document   : ShowConfirmInsertProductView
    Created on : 9 Φεβ 2010, 6:15:07 μμ
    Author     : Valitsa
--%>
...
<title>Επιβεβαίωση εισαγωγής προϊόντος</title>
   ...
   <%@include file="header.html" %>
  	...
  	<%@include file="option_bar.jsp" %>
        ...
        <table id="breadcrumb" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td valign="top" class=""><a href="Controller?action=showChangeProductPage">Eισαγωγή προϊόντος</a></td>                
            </tr>
        </table>
	...
	<div id="main_menu">
		<table class="bigger" cellspacing="3" cellpadding="3">
			<tr><td class="blueheader"> <b>Αδυναμία εισαγωγής προϊόντος</b></td></tr>
		</table>
		<table class="bigger" cellspacing="3" cellpadding="3">
                    <tr><td align="center" ><h3 style="margin-left:auto">Η εισαγωγή του νέου προϊόντος δεν μπόρεσε να πραγματοποιηθεί.</h3></td></tr>
                        <tr><td align="center"><h3 style="margin-left:auto">O κωδικός πρόσβασης που εισάγατε υπάρχει ήδη.</h3></td>
                    </tr>
                    <tr><td>
                     <p>&nbsp;</p>
