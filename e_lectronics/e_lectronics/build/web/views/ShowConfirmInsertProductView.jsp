   ...
   <%@include file="header.html" %>
  	...
  	<%@include file="option_bar.jsp" %>
        ...
        <table id="breadcrumb" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td valign="top" class=""><a href="Controller?action=showChangeProductPage">Αλλαγή προϊόντος</a></td>
	...
	<div id="main_menu">                
		<table class="bigger" cellspacing="3" cellpadding="3">
			<tr><td class="blueheader"> <b>Επιβεβαίωση εισαγωγής προϊόντος</b></td></tr>
		</table>
		<table class="bigger" cellspacing="3" cellpadding="3">
                    <tr><td align="center" colspan=2"><h2 style="margin-left:auto">Η εισαγωγή του νέου προϊόντος πραγματοποιήθηκε με επιτυχία!</h2></td>
                    <tr><td>
                     <p>&nbsp;</p>
