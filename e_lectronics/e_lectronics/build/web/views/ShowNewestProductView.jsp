  ...
  <div id="menucontainer">
	...
	<%@include file="option_bar.jsp" %>
        ...
        <table id="breadcrumb" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td valign="top" class="current"><a href="#">Νέες Παραλαβές</a></td>
            </tr>
        </table>
	...
	<div id="main_menu">
		...
		<table class="bigger" cellspacing="3" cellpadding="3">
			<tr>
				<td class="header"><a href="Controller?action=showNewestProductsPage"> <b>Νέες Παραλαβές</b></a></td>
			</tr>
		</table>

                <form name="orderBy" action="Controller?action=showNewestProductsPage#sBy" method="post">
                    <table class="bigger">
                        <tr>
