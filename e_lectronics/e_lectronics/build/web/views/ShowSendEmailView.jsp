<%-- 
    Document   : ShowSendEmailView
    Created on : 28 Φεβ 2010, 2:18:48 μμ
    Author     : Valitsa
--%>
   ...
   <%@include file="header.html" %>
	...
	<%@include file="option_bar.jsp" %>
        ...
        <table id="breadcrumb" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td valign="top" class=""><a href="Controller?action=showContactPage">Επικοινωνία</a></td>
                <td valign="top" class="current"><a href="#">Aποστολή e-mail</a></td>
            </tr>
        </table>
	...
	<div id="main_menu">
		...
		<table class="bigger" cellspacing="3" cellpadding="3">
			<tr><td class="header"> <b>Eπιβεβαίωση αποστολής e-mail</b></td></tr>
		</table>


		<table class="bigger" cellspacing="3" cellpadding="3">
                    <tr><td colspan=2"><h2 style="margin-left:auto">To e-mail σας στάλθηκε με επιτυχία. </h2></td>
                    <tr><td>
                     <p>&nbsp;</p>
